...
| ```Nickname```  | ```String``` | Your display name. If you have a nickname in the spamming server, enter this instead of display name. If your name has more than 2 words, just enter 1 of the 2 |
